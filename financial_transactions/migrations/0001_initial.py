...
class Migration(migrations.Migration):
    def forwards(self, orm):
        ...
        db.create_table(u'financial_transactions_transaction', (
            ...
            ('date_on_receipt',
             self.gf('django.db.models.fields.DateField')(null=True,
                                                          blank=True)),
            ('amount',
             self.gf('django.db.models.fields.DecimalField')(max_digits=11,
                                                             decimal_places=2)),
            ('currency',
        ...
        db.create_table(u'financial_transactions_transactioncategoryhint', (
            (u'id',
             self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(
                to=orm['categories.Category'])),
            ('memo_like',
             self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'financial_transactions',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'financial_transactions_transaction',
                         [u'id', 'account_id'])
    ...
    models = {
        u'categories.category': {
            ...
            'alternate_title': ('django.db.models.fields.CharField', [],
                                {'default': "''", 'max_length': '100',
                                 'blank': 'True'}),
            'alternate_url': ('django.db.models.fields.CharField', [],
            ...
            u'lft': ('django.db.models.fields.PositiveIntegerField', [],
                     {'db_index': 'True'}),
            'meta_extra': ('django.db.models.fields.TextField', [],
                           {'default': "''", 'blank': 'True'}),
        ...
        u'financial_transactions.transaction': {
            'Meta': {'unique_together': "(('id', 'account'),)",
                     'object_name': 'Transaction'},
            'account': ('django.db.models.fields.related.ForeignKey', [],
                        {'to': u"orm['financial_transactions.Account']"}),
            'amount': ('django.db.models.fields.DecimalField', [],
                       {'max_digits': '11', 'decimal_places': '2'}),
            'category': ('django.db.models.fields.related.ForeignKey', [],
                         {'to': u"orm['categories.Category']", 'null': 'True',
                          'blank': 'True'}),
            'currency': (
            'django.db.models.fields.CharField', [], {'max_length': '3'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'date_on_receipt': ('django.db.models.fields.DateField', [],
                                {'null': 'True', 'blank': 'True'}),
            'foreign_amount': ('django.db.models.fields.DecimalField', [],
                               {'null': 'True', 'max_digits': '11',
                                'decimal_places': '2', 'blank': 'True'}),
            'foreign_currency': ('django.db.models.fields.CharField', [],
